...
![Hero section showing the dark editorial layout with the headline "Where Japan Meets China" overlaid on a faint kanji watermark, with navigation and a red Book Table button](assets/preview-hero.png)

![Three signature dining experiences laid out side by side: The Kaiseki (sushi roll), The Imperial (dim sum in bamboo steamers), and The Omakase (shrimp in spiced broth)](assets/preview-menu.png)

![Six-cell Process grid covering knife & wok, fermentation, binchotan & wok, tea & spirit, seasonal soul, and harmony, with a grilled-meat image revealed on the third cell](assets/preview-process.png)

![Reservation form with the headline "Secure Your Table", location/service/dress info cards on the left, and floating-label inputs for name, email, date, guests, and notes plus a red Request Reservation button on the right](assets/preview-reservation.png)
